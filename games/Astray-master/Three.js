...
THREE.Object3D.prototype = {
    ...
    getChildByName: function(a, b) {
        var c, d, e;
        c = 0;
        for (d = this.children.length; c < d; c++) { e = this.children[c]; if (e.name === a) return e; if (b) { e = e.getChildByName(a, b); if (e !== void 0) return e } }
    },
...
THREE.SceneLoader.prototype.createScene = function(a, b, c) {
    ...
    for (r in D.textures) {
        k = D.textures[r];
        if (k.url instanceof Array) { i = i + k.url.length; for (n = 0; n < k.url.length; n++) j.onLoadStart() } else {
            i = i + 1;
            j.onLoadStart()
        }
    }
...
THREE.MorphAnimMesh.prototype.updateAnimation = function(a) {
    ...
    } else { this.time = this.time % this.duration; if (this.time < 0) this.time = this.time + this.duration }
...
THREE.UniformsUtils = {
    merge: function(a) { var b, c, d, e = {}; for (b = 0; b < a.length; b++) { d = this.clone(a[b]); for (c in d) e[c] = d[c] } return e },
    clone: function(a) {
        var b, c, d, e = {};
        for (b in a) {
            e[b] = {};
...
THREE.GeometryUtils = {
    ...
    randomPointsInGeometry: function(a, b) {
        function c(a) {
            function b(c, d) { if (d < c) return c; var e = c + Math.floor((d - c) / 2); return l[e] > a ? b(c, e - 1) : l[e] < a ? b(e + 1, d) : e }
...
THREE.Curve.Utils = {
    ...
    tangentSpline: function(a) { return 6 * a * a - 6 * a + (3 * a * a - 4 * a + 1) + (-6 * a * a + 6 * a) + (3 * a * a - 2 * a) },
...
THREE.SplineCurve3 = THREE.Curve.create(function(a) { this.points = a == void 0 ? [] : a }, function(a) {
    var b = new THREE.Vector3,
        c = [],
        d = this.points,
        e, a = (d.length - 1) * a;
                    ...
                    for (t = 0; t < r; t++)
                        if (!(t == o || t == q || t == n)) {
                            var v = m[u[t]].x,
                                ...
                                D = D * i - M * G,
                                R = R * Y - P * C;
                            if (J >= 0 && R >= 0 && D >= 0) { m = false; break a }
                        }
                    m = true
                }
            }
...
THREE.CameraHelper.prototype.update = function() {
    function a(a, d, e, f) {
        ...
        a = b.pointMap[a];
        if (a !== void 0) { d = 0; for (e = a.length; d < e; d++) b.lineGeometry.vertices[a[d]].copy(THREE.CameraHelper.__v) }
    }
    var b = this;
...
THREE.MorphBlendMesh.prototype.update = function(a) {
    for (var b = 0, c = this.animationsList.length; b < c; b++) {
        ...
        if (d.active) {
            ...
            } else { d.time = d.time % d.duration; if (d.time < 0) d.time = d.time + d.duration }
