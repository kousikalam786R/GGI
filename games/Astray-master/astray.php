...
<html>
    ...
    <head>
    <title>Gaming Galaxy - Astray Maze</title>
            ...
            function gameLoop() {
                ...
                switch(gameState) {
                    ...
                    case 'initialize':
                        ...
                        $('#coins').html('<img src="Dollar-Coins-PNG_azdjjc.png" alt=""><p>' +' '+ coins+' </p> ' );
                        $('#level').html('Level ' + level);
                        var coincount = Math.floor(level/5);
                        gameState = 'fade in';
                        // call ajax to post data to database for levels and coins on runtime and will be called back to display back
                        $.ajax({

                            type: "POST",
                            url: "actions.php?action=updateLevelCoin",
                            data: "level=" + level + "&coins=" + coins + "&account=" + "<?php echo $account; ?>",
                            success:function() {
