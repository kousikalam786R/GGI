...
//Returns the two intersection points of the line segment and the ellipse, if they do not intersect, return null
function lineXEllipse( p1, p2, c, r, e ){
	// line segment：p1, p2   Center: c Radius: r Eccentricity: e
	if (r <= 0) return;
	e = e === undefined ? 1 : e;
	var t1 = r, t2 = r * e, k;
...
// Determine whether the calculated line segment and the ellipse intersect
